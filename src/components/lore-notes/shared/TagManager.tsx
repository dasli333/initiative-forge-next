...
import { TAG_COLORS, TAG_ICONS } from '@/types/lore-note-tags';
...
interface TagManagerProps {
  ...
  onCreate: (name: string, color: string, icon: string) => Promise<LoreNoteTagDTO>;
  disabled?: boolean;
  maxTags?: number;
}

/**
 * Tag manager for lore notes
 * - Display assigned tags with remove button
 * - Add tag popover: select existing or create new
 * - Max 20 tags per lore note (configurable)
 * - Pattern similar to LanguageSelector
 */
export function TagManager({
  campaignId: _campaignId,
  loreNoteId: _loreNoteId,
  assignedTags,
  availableTags,
  onAssign,
  onUnassign,
  ...
  const [newTagIcon, setNewTagIcon] = useState<string>('BookOpen');
                ...
                <div className="space-y-3 pt-2 border-t">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      placeholder="e.g., Ancient, Secret"
                      disabled={isLoading}
                      maxLength={30}
