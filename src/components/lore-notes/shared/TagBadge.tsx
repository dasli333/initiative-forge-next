...
export function TagBadge({
  ...
  // Convert color to Tailwind classes
  const colorClasses = `bg-${tag.color}-100 text-${tag.color}-800 border-${tag.color}-200 dark:bg-${tag.color}-900/30 dark:text-${tag.color}-300 dark:border-${tag.color}-700`;
